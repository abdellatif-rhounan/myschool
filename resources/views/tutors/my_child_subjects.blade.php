...
@section('title', 'My Child Subjects')

@section('left_header')
	<div>My Child ({{ $student->name }}) Subjects (Total: {{ $subjects->total() }})</div>

	<div class="mt-3">Class ({{ $className }})</div>
@endsection
		...
		<form class="mb-3" method="get">
			<div class="row align-items-center">
				...
				<div class="col-4">
					...
					<a class="btn btn-danger px-4" href="{{ route('my-child-subjects', $student->id) }}" style="position: relative; top: 7px;">
						Reset
					</a>
				</div>
			</div>
