	...
	<ul class="navbar-nav ml-auto">
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
				...
				<a class="dropdown-item my-2 py-2" href="{{ route('profile') }}" style="font-size: 16px">
				...
				<a class="dropdown-item my-2 py-2" href="{{ route('change-password') }}" style="font-size: 16px">
					<i class="nav-icon fas fa-key mr-2"></i>
