...
@section('title')
	{{ $teacher->firstname }} {{ $teacher->lastname }} Profile
@endsection
	...
	<div class="col-lg-6 mx-auto mt-2">
		<div class="card card-success">
			...
			<div class="card-header">
				<h3 class="card-title">{{ $teacher->firstname }} {{ $teacher->lastname }} Profile</h3>
			</div>

			<div class="card-body">
				<div>
					<label for="firstname">Firstname :</label>
					<span class="ml-2">{{ $teacher->firstname }}</span>
				</div>

				<div>
					<label for="lastname">Lastname :</label>
					<span class="ml-2">{{ $teacher->lastname }}</span>
				</div>
				...
				<div>
					...
					<span class="text-capitalize ml-2">{{ $teacher->gender }}</span>
				</div>
				...
				<div>
					...
					<span class="ml-2">{{ $teacher->creator->firstname }} {{ $teacher->creator->lastname }}</span>
				</div>
			</div>
